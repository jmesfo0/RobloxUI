        ...
        function tabSections:addSection(secTitle)
            ...
            function secItems:newSection(secName, hidden)
                ...
                function Elements:addSlider(slidInf, slidTip, minvalue, maxvalue, startVal, callback)
					...
					Options[slidInf] = startVal
                end

                function Elements:addDropdown(dropname, dropinf, default, list, callback)
                    local DropFunction = {}
					...
					function DropFunction:Set(Text)
						dropOpen.Text = Text
					end
