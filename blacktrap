...
function Blacklib:Window(WindowName)
    ...
    function Tabs:Tab(tabtitle, img)
		...
		return togglefunc
            ...
            -- Dropdown --
            function ItemHand:Dropdown(droptitle, v, list, callback)
                -- Local --
                local dropfunc = {}
                local list = list or {}
            ...
            -- Slider --
            function ItemHand:Slider(slidertitle, minvalue, maxvalue, start, callback)
            local sliderfunc = {}
            ...
            SliderFrame.Size = UDim2.new(0, 325, 0, 45)
            ...
            SliderInput.Size = UDim2.new(0, 325, 0, 9)
            ...
            SliderBox.Position = UDim2.new(0, 320, 0, -1)
            SliderBox.Size = UDim2.new(0, 25, 0, 15)
